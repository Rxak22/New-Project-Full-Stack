<?php 
    ...
    $sql = "SELECT tbl_users.firstName AS firstName, tbl_users.lastName AS lastName, tbl_social.* ";
    $sql .= "FROM tbl_users INNER JOIN tbl_social ON tbl_users.id = tbl_social.publisher_id LIMIT 5 OFFSET $offset";
                        ...
                        <div class="bottom view-post">
                            <figure>
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><img src="https://res.cloudinary.com/dvsqwcz7u/image/upload/<?php echo $row["social_logo"]; ?>.jpg" alt="" width="80" height="80"></td>
                                                <td><?php echo $row["label"]; ?></td>
                                                <td><?php echo $row["url"]; ?></td>
                                                <td><?php echo $row["firstName"]. " ". $row["lastName"]; ?></td>
                                                <td><?php echo $row["create_date"]; ?></td>
                                                <td width="150px" class="d-flex">
                                                    <a href="update_social.php?pre=<?php echo $offset; ?>&id=<?php echo $row["id"]; ?>" class="btn btn-primary" style="margin-right: 7px; padding: 5px 10px;">Modify</a>
                                    ...
                                    <ul class="pagination">
                                        <li>
                                            <a href="view-social.php?next=0">1</a>
                                            <a href="view-social.php?next=5">2</a>
                                            <a href="view-social.php?next=10">3</a>
                                            <a href="view-social.php?next=15">4</a>
                                        </li>
                                    </ul>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                        ...
                                                        <button type="submit" class="btn btn-danger" name="accept_remove_social">Yes</button>
