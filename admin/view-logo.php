<?php
    ...
    $sql = "SELECT * FROM tbl_logo ORDER BY id DESC LIMIT 5 OFFSET $offset";
                                ...
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <table class="table" border="1px">
                                        ...
                                        <tr>
                                            ...
                                            <td><img width="80px" height="80px" src="https://res.cloudinary.com/dvsqwcz7u/image/upload/<?php echo $row["thumnail"]; ?>.jpg" alt="<?php echo $row["thumnail"] ?>"/></td>
                                    ...
                                    <ul class="pagination">
                                        <li>
                                            <a href="view-logo.php?next=0">1</a>
                                            <a href="view-logo.php?next=5">2</a>
                                            <a href="view-logo.php?next=10">3</a>
                                            <a href="view-logo.php?next=15">4</a>
                                        </li>
                                    </ul>
                                    <!-- Modal -->
